...
func (f *FileSystemService) ParseAbsPath(parts ...string) (string, error) {
...
// ParseBase return the base component from the provided path
func (f *FileSystemService) ParseBase(path string) string {
	return f.fs.Base(path)
}
